...
// Employee data - replace placeholders as needed
const employeeData = {
    name: "Bharathi Nesar",
    title: "Digital Transformation Engineer",
    employeeId: "AA-202542",
    department: "Digital Transformation",
    employmentType: "Full-time",
    dateJoined: "22 September 2025",
    workMode: "On Site",
    ...
    verificationUrl: "https://employees.dileka.co/bharathinesar",
};
                ...
                <div className="verification-card bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden print-break">
                    ...
                    <div className="px-6 sm:px-10 pt-8 pb-6 text-center border-b border-slate-100">
                        ...
                        <div className="inline-block avatar-ring rounded-full mb-5">
                            <div className="w-28 h-28 sm:w-32 sm:h-32 rounded-full overflow-hidden bg-slate-100">
                                <Image
                                    src="/avatar.png"
